...
function BrandPage({brandPageSelection, setName, setQuantity, setImages, setPrice, setSale, setDescription}) {
    ...
    useEffect(() => {
        console.log("Brand Page Selection:", brandPageSelection);
        ...
        const isPageRefreshed =
            (brandPageSelection === null || brandPageSelection === '') &&
            !sortAlpha &&
            !sortAvail &&
            !sortLowest &&
            !sortHighest;
    ...
    }, [brandPageSelection, sortAlpha, sortAvail, sortLowest, sortHighest]);

    return (
        <div className={isLightMode ? "light-query-container" : "query-container"}>
            <div className="query-wrapper">
                <div className="query-header">
                    <span className={isLightMode ? "light-content-header" : "content-header"}>Showing Brand: {brandPageSelection}</span>
                </div>
                ...
                <div className={isLightMode ? "light-query-body" : "query-body"}>
                    <ItemList brand={brandPageSelection}
                              maxItems={100}
                              setName={setName}
